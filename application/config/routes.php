...
$route['api/cart-get.json'] = 'api/Api_transaksi/getCart';
$route['api/cart-edit.json'] = 'api/Api_transaksi/editCart';
$route['api/cart-delete.json'] = 'api/Api_transaksi/deleteCart';
